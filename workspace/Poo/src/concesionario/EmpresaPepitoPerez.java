...
public class EmpresaPepitoPerez {
	...
	public static void main(String[] args) {
		...
		// cambiar color del coche de rojo a azul (requiere método expresado en
		// coches.java
		...
		System.out.println("La matrícula del coche de ventas " + cocheEmpresaVentas.getMatricula());
		System.out.println("La matrícula del coche del jefe " + cocheEmpresaDireccion.getMatricula());
